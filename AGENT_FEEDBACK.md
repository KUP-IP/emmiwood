...
- 2026-07-22: SMS-only v1 locked admin auth to allowlisted phone OTP and dropped Resend from production `notificationReadiness` / release-preflight required secrets. Email channel remains reportable as deferred, not launch-blocking.
