...
17. **Handoff SSOT (2026-08-31 recon; operator Path A lock 2026-09-01):** Path A is the locked deploy model for client handoff. Index: [`docs/HANDOFF.md`](HANDOFF.md). Amends older lines that still described pre-cutover topology:
